  ...
  return (
    <div className="explore-shell -mx-6 -mt-4 w-[calc(100%+3rem)] px-6 pb-10 pt-5 sm:mx-auto sm:mt-0 sm:w-full sm:max-w-7xl sm:rounded-sheet sm:p-7 lg:p-8">
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-[1.35fr_.65fr]">
        <section className="rounded-panel bg-brand-dark p-5 text-white shadow-[0_18px_45px_rgba(20,55,41,.14)] sm:p-6">
        ...
        <section className="rounded-panel border border-black/[0.05] bg-surface p-5 shadow-soft"><p className="text-xs font-bold uppercase tracking-[0.13em] text-muted">Accesos rápidos</p><div className="mt-3 divide-y divide-border/70"><QuickLink href="/propietarios/solicitudes" icon={<Users />} title="Solicitudes" subtitle="Revisa personas interesadas" /><QuickLink href="/propietarios/mensajes" icon={<MessageCircle />} title="Conversaciones" subtitle="Continúa donde lo dejaste" /></div></section>
      </div>
