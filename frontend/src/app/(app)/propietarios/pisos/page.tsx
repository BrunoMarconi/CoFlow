...
function EmptyProperties() { return <div className="rounded-[1.5rem] border border-[#dddddd] bg-white px-6 py-14 text-center"><Building2 className="mx-auto h-12 w-12" /><h2 className="mt-5 text-2xl font-semibold">Tu primer piso empieza aquí</h2><p className="mx-auto mt-2 max-w-sm text-sm leading-6 text-[#717171]">Publica tu vivienda y gestiona todo desde un único lugar.</p><Link href="/propietarios/pisos/nuevo" className="mt-6 inline-flex h-12 items-center gap-2 rounded-full bg-black px-6 font-semibold text-white"><Plus className="h-5 w-5" />Añadir piso</Link></div>; }
