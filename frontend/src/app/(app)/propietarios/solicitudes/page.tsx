...
export default function SolicitudesPropietarioPage() {
  ...
  return (
    <div className="explore-shell -mx-6 -mt-4 w-[calc(100%+3rem)] px-6 pb-10 pt-5 sm:mx-auto sm:mt-0 sm:w-full sm:max-w-7xl sm:rounded-sheet sm:p-7 lg:p-8">
      ...
      <section className="mt-4 rounded-panel border border-primary/10 bg-mint-50/70 p-4 sm:flex sm:items-center sm:justify-between sm:gap-5 sm:p-5">
      ...
      <section className="mt-4 grid gap-4 lg:grid-cols-[1fr_18rem]">
        <div className="flex min-h-[25rem] flex-col items-center justify-center rounded-panel bg-surface px-6 py-12 text-center shadow-soft">
