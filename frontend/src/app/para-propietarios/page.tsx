      ...
      <div className="mx-auto max-w-[760px] px-4">
        <section className="pb-7 pt-5">
          ...
          <article data-apple-tilt className="apple-tilt mt-5 rounded-[28px] bg-white p-2 shadow-[0_12px_34px_rgba(25,45,36,0.07)]">
            <div className="relative aspect-[1.62] overflow-hidden rounded-[20px]"><Image src="https://images.unsplash.com/photo-1641667710644-fb8a6abf2a06?auto=format&fit=crop&q=85&w=1400" alt="Vista urbana de Málaga" fill priority sizes="448px" className="object-cover" /><div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent" /><span className="absolute left-2.5 top-2.5 rounded-full bg-[#263b32]/80 px-2.5 py-1 text-[12px] text-white backdrop-blur">Vivienda en Málaga</span><span className="absolute right-2.5 top-2.5 rounded-full bg-white/90 px-2.5 py-1 text-[12px]">Plazas disponibles</span></div>
            <div className="px-2 pb-2 pt-3"><div className="flex justify-between gap-3"><div><h2 className="text-[18px] font-semibold">Publica tu vivienda en Málaga</h2><p className="mt-1 text-[13px] leading-6 text-[#747b77]">Añade su ubicación, capacidad, condiciones y plazas disponibles.</p></div><span className="h-fit shrink-0 rounded-full bg-[#f1f2f1] px-2 py-1 text-[12px]">Málaga</span></div><div className="mt-2.5 flex flex-wrap gap-1.5"><SmallTag>Publicación gratuita</SmallTag><SmallTag>Contacto directo</SmallTag><SmallTag>Solicitudes</SmallTag></div><div className="mt-3 flex items-center justify-between border-t border-black/5 pt-3"><span className="text-[12px] text-[#8b918e]">Tú decides a quién responder</span><Link href="/register?role=owner" className="rounded-full bg-[#315f4b] px-3 py-2 text-[13px] font-semibold text-white">Publicar ahora</Link></div><p className="mt-2 text-[11px] text-[#a0a5a2]">Foto de <a href="https://unsplash.com/photos/Nx0C3cDKRLw" target="_blank" rel="noreferrer" className="underline">Yuliya Matuzava</a> en Unsplash</p></div>
          </article>
        </section>
