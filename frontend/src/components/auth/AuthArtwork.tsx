...
export default function AuthArtwork({ variant }: { variant: "login" | "register" }) {
  ...
  return <div className={`relative overflow-hidden rounded-24 border border-border bg-surface shadow-soft ${isLogin ? "h-52 sm:h-64 lg:h-[31rem]" : "h-48 sm:h-64 lg:h-[31rem]"}`}>
