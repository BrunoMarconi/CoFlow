      ...
      <section className="border-b border-[#e1ebe6]">
        <div className="mx-auto grid min-h-[600px] max-w-[1440px] grid-cols-[1.02fr_.98fr] items-center gap-16 px-10 py-16 xl:px-14">
          <div className="max-w-[690px]">
            <Eyebrow>CoFlow para propietarios</Eyebrow>
            <h1 className="mt-6 text-[clamp(58px,5.1vw,82px)] font-semibold leading-[.94] tracking-[-.06em]">Tu vivienda en calma.<br /><span className="font-normal italic text-[#64716b]">Alquilar con serenidad.</span></h1>
            <p className="mt-7 max-w-[620px] text-[17px] leading-7 text-[#66736d]">Conoce a las personas interesadas, consulta su presupuesto y preferencias de convivencia y mantén el control antes de responder.</p>
          ...
          <article data-apple-tilt className="apple-tilt ml-auto w-full max-w-[590px] overflow-hidden rounded-[30px] bg-white p-2.5 shadow-[0_28px_70px_rgba(26,58,45,.13)]">
            <div className="relative aspect-[1.7] overflow-hidden rounded-[23px]"><Image src="https://images.unsplash.com/photo-1612972806701-9cffb7470ed2?auto=format&fit=crop&q=88&w=1500" alt="Vista panorámica de Málaga desde Gibralfaro" fill priority sizes="590px" className="object-cover" /><div className="absolute inset-0 bg-gradient-to-t from-black/55 via-transparent to-black/5" /><span className="absolute left-4 top-4 rounded-full bg-[#244638]/85 px-3 py-1.5 text-[11px] font-medium text-white backdrop-blur">Vivienda en Málaga</span><span className="absolute right-4 top-4 rounded-full bg-white/90 px-3 py-1.5 text-[11px] font-medium backdrop-blur">Plazas disponibles</span><div className="absolute bottom-4 left-4 text-white"><p className="text-[11px] uppercase tracking-[.14em]">Publicación para propietarios</p><h2 className="mt-1 text-[26px] font-semibold tracking-[-.035em]">Presenta tu vivienda con claridad</h2></div></div>
