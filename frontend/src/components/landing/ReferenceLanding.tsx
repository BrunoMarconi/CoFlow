    ...
    <main className="motion-landing min-h-dvh bg-[#f4f4f7] text-[#18251f]">
      ...
      <div className="resident-desktop mx-auto max-w-[760px] px-4 lg:max-w-7xl lg:px-8">
        <section className="pb-7 pt-5">
          ...
          <p className="mt-4 max-w-[580px] text-[16px] leading-[1.55] text-[#727975]">Conectamos personas afines para crear hogares armónicos y respetuosos, con hábitos, presupuesto y preferencias visibles antes de decidir.</p>
          ...
          <article data-apple-tilt className="apple-tilt mt-5 rounded-[28px] bg-white p-2 shadow-[0_12px_34px_rgba(25,45,36,0.07)]">
            ...
            <div className="px-2 pb-2 pt-3">
              ...
              <p className="mt-2 text-[11px] text-[#a0a5a2]">Foto de <a href="https://unsplash.com/photos/Nx0C3cDKRLw" target="_blank" rel="noreferrer" className="underline">Yuliya Matuzava</a> en Unsplash</p>
            </div>
          </article>
        </section>
        ...
        <section id="propietarios" className="resident-owner-section py-12">
          ...
          <div className="mt-4 rounded-[28px] bg-white p-3 shadow-[0_10px_28px_rgba(25,45,36,0.055)]">
            ...
            <p className="mt-2 px-1 text-[11px] text-[#a0a5a2]">Foto de <a href="https://unsplash.com/photos/mPw1d9pwZsI" target="_blank" rel="noreferrer" className="underline">Bas van der Linden</a> en Unsplash</p>
