...
import ActionFeedback from "@/components/interaction/ActionFeedback";
          ...
          >
            ...
            >
              <ViewTransition enter={NAV_TRANSITION} exit={NAV_TRANSITION} default="none">
                {hidesAppChrome ? children : <SwipeNavigation>{children}</SwipeNavigation>}
              </ViewTransition>
            </motion.div>
          </div>
        </main>
