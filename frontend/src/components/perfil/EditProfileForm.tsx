...
type ProfileStep = "bio" | "name" | "age" | "phone" | "occupation" | "looking" | "budget";
const STEPS: ProfileStep[] = ["bio", "name", "age", "phone", "occupation", "looking", "budget"];
